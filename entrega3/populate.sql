...
insert into Alugavel values ('Rua dos Limoes',5,'.');
insert into Alugavel values ('Rua dos Limoes',6,'.');
insert into Alugavel values ('Rua das Laranjas',2,'.');
insert into Alugavel values ('Rua das Laranjas',3,'.');
insert into Alugavel values ('Rua das Laranjas',4,'.');
insert into Alugavel values ('Rua das Peras',10,'.');
insert into Alugavel values ('Rua das Laranjas',3,'.');
...
insert into Espaco values ('Rua das Peras',10);	
insert into Espaco values ('Rua das Laranjas',3);

insert into Posto values ('Rua das Laranjas',2,1);
insert into Posto values ('Rua das Laranjas',3,1);
insert into Posto values ('Rua das Laranjas',4,1);
